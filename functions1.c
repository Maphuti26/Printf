 ...
 * @flags: Calculates active flags.
 * @width: Get width.
 * @pecisicion: Precision specification.
 * @size: Size specifier.
 * Return: Number of chars printed.
 */
...
/**
 * print_hexadecimal - Prints an unsigned number in upper hexadecimal notation
 * @types: List of arguments.
 * @buffer: Buffer array to handle print.
 * @flags: Calculates active flags.
 * @width: Get width.
...
/**
 * print-hexa - Prints a hexadecimal number in lower or upper case
 * @types: List of arguments
